      ...
      <div className="rounded-lg w-full max-w-2xl cursor-pointer">
        <div className="flex flex-col items-center">
          ...
          >
            ...
            />
            <path
              d="M107.729 111.425C111.666 108.706 119.538 103.27 119.538 103.27C121.172 102.168 123.365 102.42 124.706 103.864L131.879 111.587C132.237 111.972 132.833 112.014 133.242 111.683L148.581 99.2534C150.298 97.8626 152.817 98.1266 154.207 99.843C154.297 99.9539 154.381 100.07 154.459 100.189C154.459 100.189 163.427 114.42 165.523 117.745"
              className="stroke-primary"
              strokeWidth="2.5"
              strokeLinecap="round"
            />
